...
#include "../../src/OMP_Offload/off_fun.h"
...
void test_off_dotproduct(){
    ...
    double dot = off_dot_product(x, x);
...
void test_off_sparse_CSR_large_power_method(){
...
void test_sparse_off_matvec_mult(){
...
off_sparse_matvec_mult_CSR(my_csr,x,y);
...
void test_dense_off_matvec_mult(){
...
void test_dense_off_approximate_eigenvalue(){
...
void test_dense_off_power_method(){
    denseMatrix A;
    A.rows = 2;
    A.cols = 2;
    A.data = malloc(sizeof(double) * 4);
...
void test_serial_CSR_pkustk13(){
    ...
    printf("pkustk13: average time: %.6f\n", total_time/10);
...
int main(int argc, char* argv[]){
    ...
    CU_pSuite suite = CU_add_suite("Power Method openMP offload Tests", NULL, NULL);

    // Tests for common functions.
    //CU_add_test(suite, "Vector normalization test", test_off_norm);
    //CU_add_test(suite, "dotproduct test", test_off_dotproduct);

    //CU_add_test(suite, "Power method test large CSR", test_off_sparse_CSR_large_power_method);
    //CU_add_test(suite, "sparse matrix-vector multi test", test_sparse_off_matvec_mult);

    //CU_add_test(suite, "Matrix vector multiplication test", test_dense_off_matvec_mult);
    //CU_add_test(suite, "Approximate eigenvalue test", test_dense_off_approximate_eigenvalue);
