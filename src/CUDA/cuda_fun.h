...
void launch_dotprod_kernel(double* x, double* y, double* result, int n, int numBlocks);
void launch_reduce_kernel(double* input, double* output, int currentSize, int nextSize, int blockSize);
